...
impl PlanetShader for RockyPlanetShader {
    ...
    fn fragment_shader(&self, position: Vector3, normal: Vector3, uv: (f32, f32), uniforms: &ShaderUniforms) -> ShaderColor {
        ...
        let darkest_gray = ShaderColor::from_rgb(20, 20, 25);      
        let dark_gray = ShaderColor::from_rgb(50, 50, 55);         
        let medium_dark = ShaderColor::from_rgb(80, 80, 85);       
        let medium_gray = ShaderColor::from_rgb(110, 110, 115);    
        let light_gray = ShaderColor::from_rgb(140, 140, 145);     
        let lighter_gray = ShaderColor::from_rgb(170, 170, 175);   
        let lightest_gray = ShaderColor::from_rgb(200, 200, 205);  
